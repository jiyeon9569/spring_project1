	...
	<div class="container">
			...
			<%if(total_count>0){ %>
				...
				%>
					...
					<tr>
						...
						<td>
							<a href="/notice_view.do?notice_idx=<%=notice_idx%>"><%=notice_title %></a>
						</td>
		...
		<div class="text-center" >
			...
			<nav>
			  <ul class="pagination">
			    <li>
			      <a href="/notice_default.do?current_page=1" aria-label="Previous">
			    ...
			    <li>
			      <a href="/notice_default.do?current_page=<%=total_page%>" aria-label="Next">
