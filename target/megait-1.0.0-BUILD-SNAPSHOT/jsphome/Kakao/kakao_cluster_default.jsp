	...
	<div class="container">
		...
		<h3>공공도서관 주소 분포</h3>
			...
			<p style="margin-top:-12px">
			    사용한 데이터를 보시려면 
			    <em class="link">
			       <a href="/library_api_default2.do" target="_blank">여기를 클릭하세요!</a>
			    </em>
			</p>
			...
			<script>
			    ...
			    $.get("/library_api_default2.do", function(data) {
			        // 데이터에서 좌표 값을 가지고 마커를 표시합니다
			        // 마커 클러스터러로 관리할 마커 객체는 생성할 때 지도 객체를 설정하지 않습니다
			        var markers = $(data.DATA).map(function(i, position) {
			        	console.log(parseFloat(position.latitude));
			            return new kakao.maps.Marker({
			                position : new kakao.maps.LatLng( position.library_idx, position.library_idx)
			            });
			        });
