	...
	<div class="container center" >
	    ...
	    <table class="table" style="width:100%;">
	        ...
	        <tr>
	            ...
	            <td style="width:80%">
	                <input type="number" class="form-control" style="width:200px;max-width: 150px;" name="member_birth" id="member_birth" placeholder="생년월일" >
	    ...
	    <div class="col-lg-12 text-center">	
		    ...
		    <input type="hidden" name="test_name" value="김장현">
	    </div>
	    </form>
